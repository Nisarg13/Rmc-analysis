...
def create_api_ui():
    main_layout=html.Div([
       ...
       dcc.Tabs(id="tabs-styled-with-props", value='tab-1', children=[
        dcc.Tab(label='Department and Complaint Analysis', value='tab-1',children=[html.Div(),
        dcc.Dropdown(
        id='area-dropdown', 
        options=area_list,
    ...
    labelStyle={'display': 'inline-block','margin-left':'500px'},
        ...
        dcc.Tab(label='Area vs Area Analysis', value='tab-2',children=[html.Div(),
        dcc.Dropdown(
        id='area-dropdown1', 
        options=area_list,
        placeholder='Select Area',
  ...
  dcc.Dropdown(
	...
	#'position': 'relative',   }
    style={'width':'950px', 'display': 'inline-block'},
  ),html.Button('Submit', id='btn-nclicks-1', n_clicks=0,style={
    ...
    dcc.Tab(label='Date Analysis', value='tab-3',children=[html.Div(),
        dcc.Dropdown(
        id='date-dropdown', 
        options=date_list,
 ...
 dcc.Dropdown(
  ...
  dash_table.DataTable(
        ...
        data=[],
        columns=[
            {"name": i, "id": i, "selectable": True} for i in df.columns[2:]
        ],
        editable=True,
...
def update_table(tab_value,date_value,month_value,year_value):
    global df
    if tab_value=='tab-3':
